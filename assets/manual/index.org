...
- [[concept:kb-graph-view][Native KB Graph View]] -- chord/force-directed ego-network panel, single- and multi-KB modes
...
- [[concept:gui][GUI Backend]] -- dual rendering (terminal + GUI), GUI-by-default, mouse
- [[concept:fonts][Font & Icon Configuration]] -- font_family/size, bundled Nerd Font, icon config
...
- [[concept:keymap-flavors][Keymap Flavors & the Leader Keypad]] -- modal (doom) vs non-modal (CUA), the transient which-key keypad, switching, extending
