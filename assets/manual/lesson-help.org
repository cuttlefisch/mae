...
Prerequisites: [[lesson:terminal?rel=requires][Lesson 8: Terminal]]

MAE's help is a [[concept:knowledge-base?rel=teaches][knowledge base]] — the same data the AI queries via ~kb_*~ tools.
