...
This concept [[explains:concept:collaborative-state][explains Collaborative State]].

See also: [[references:concept:sync-engine][Sync Engine]], [[concept:collab-workflows]], [[concept:collaborative-state]], [[concept:adr-text-sync]], [[index]]
