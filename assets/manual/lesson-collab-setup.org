...
This lesson [[teaches:concept:collaborative-state][teaches collaborative state]] and the [[teaches:concept:sync-engine][sync engine]]. It walks you through enabling real-time collaborative editing in MAE, from installing the daemon to sharing your first buffer with a peer.
