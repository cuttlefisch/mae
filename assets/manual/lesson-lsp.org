...
Prerequisites: [[lesson:scheme?rel=requires][Lesson 6: Scheme REPL]]

MAE has first-class LSP (Language Server Protocol) support.
LSP starts automatically when you open a supported file type.
LSP [[concept:command?rel=teaches][commands]] give you code navigation, diagnostics, and refactoring.
