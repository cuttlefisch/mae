...
**Markdown** in MAE provides structural editing for `.md` files, with the same UX as [[references:concept:org-mode][org-mode]] adapted for `#` headings.
...
See also: [[references:concept:org-mode][Org-mode]], [[references:concept:options][Editor Options]]
