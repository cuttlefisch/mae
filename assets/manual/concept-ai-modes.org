...
This concept is [[concept:ai-as-peer?rel=explains][explained by The AI as Peer Actor]].

See also: [[concept:prompt-tiers?rel=references][Prompt Tiers]], [[tutorial:ai-setup]], [[concept:ai-as-peer]], [[index]]
