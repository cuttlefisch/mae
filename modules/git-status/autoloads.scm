...
(define-key "leader" "g s" "git-status")
(define-key "leader" "g g" "git-status")
(define-key "leader" "g b" "git-blame")
(define-key "leader" "g d" "git-diff")
(define-key "leader" "g l" "git-log")
(define-key "leader" "g c" "git-commit")
(define-key "leader" "g S" "git-stage-all")
(define-key "leader" "g U" "git-unstage-all")
