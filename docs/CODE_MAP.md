...
| Function | Source |
|----------|--------|
| `add-hook!` | `scheme/src/runtime/keybindings.rs` |
| `add-to-load-path!` | `scheme/src/runtime/io_packages.rs` |
| `advice-add!` | `scheme/src/runtime/misc_primitives.rs` |
| `advice-remove!` | `scheme/src/runtime/misc_primitives.rs` |
| `agenda-add!` | `scheme/src/runtime/shell_agenda.rs` |
| `agenda-list` | `scheme/src/runtime/shell_agenda.rs` |
| `agenda-remove!` | `scheme/src/runtime/shell_agenda.rs` |
| `ai-tool-param!` | `scheme/src/runtime/kb_queries.rs` |
| `ai-tool-require!` | `scheme/src/runtime/kb_queries.rs` |
| `autoload` | `scheme/src/runtime/io_packages.rs` |
| `bind-context-keymap` | `scheme/src/runtime/keybindings.rs` |
| `buffer-apply-update` | `scheme/src/runtime/test_primitives.rs` |
| `buffer-compute-diff` | `scheme/src/runtime/test_primitives.rs` |
| `buffer-delete-range` | `scheme/src/runtime/editor_ops.rs` |
| `buffer-disable-sync` | `scheme/src/runtime/test_primitives.rs` |
| `buffer-drain-updates` | `scheme/src/runtime/state_sync_inject_kb.rs` |
| `buffer-enable-sync` | `scheme/src/runtime/test_primitives.rs` |
| `buffer-encode-state` | `scheme/src/runtime/state_sync_inject_kb.rs` |
| `buffer-encode-state-vector` | `scheme/src/runtime/test_primitives.rs` |
| `buffer-get-diff` | `scheme/src/runtime/test_primitives.rs` |
| `buffer-get-reconcile-result` | `scheme/src/runtime/test_primitives.rs` |
| `buffer-get-state-vector` | `scheme/src/runtime/test_primitives.rs` |
| `buffer-insert` | `scheme/src/runtime/editor_ops.rs` |
| `buffer-line` | `scheme/src/runtime/state_sync_inject.rs` |
| `buffer-load-sync-state` | `scheme/src/runtime/test_primitives.rs` |
| `buffer-pending-updates` | `scheme/src/runtime/state_sync_inject_kb.rs` |
| `buffer-reconcile-to` | `scheme/src/runtime/test_primitives.rs` |
| `buffer-redo` | `scheme/src/runtime/editor_ops.rs` |
| `buffer-replace-range` | `scheme/src/runtime/editor_ops.rs` |
| `buffer-string` | `scheme/src/runtime/state_sync_inject_kb.rs` |
| `buffer-sync-content` | `scheme/src/runtime/state_sync_inject_kb.rs` |
| `buffer-sync-enabled?` | `scheme/src/runtime/state_sync_inject_kb.rs` |
| `buffer-text` | `scheme/src/runtime/state_sync_inject_kb.rs` |
| `buffer-text-range` | `scheme/src/runtime/state_sync_inject.rs` |
| `buffer-undo` | `scheme/src/runtime/editor_ops.rs` |
| `buffer-undo-boundary` | `scheme/src/runtime/editor_ops.rs` |
| `check-deprecated` | `scheme/src/runtime/misc_primitives.rs` |
| `collab-confirmed-shares` | `scheme/src/runtime/state_sync_inject_kb.rs` |
| `collab-connect` | `scheme/src/runtime/kb_primitives.rs` |
| `collab-disconnect` | `scheme/src/runtime/kb_primitives.rs` |
| `collab-discover` | `scheme/src/runtime/kb_primitives.rs` |
| `collab-doctor` | `scheme/src/runtime/kb_primitives.rs` |
| `collab-list` | `scheme/src/runtime/kb_primitives.rs` |
| `collab-recover-identity` | `scheme/src/runtime/kb_primitives.rs` |
| `collab-register-recovery-key` | `scheme/src/runtime/kb_primitives.rs` |
| `collab-rotate-identity` | `scheme/src/runtime/kb_primitives.rs` |
| `collab-share` | `scheme/src/runtime/kb_primitives.rs` |
| `collab-status` | `scheme/src/runtime/state_sync_inject_kb.rs` |
| `collab-sync` | `scheme/src/runtime/kb_primitives.rs` |
| `collab-synced-buffers` | `scheme/src/runtime/state_sync_inject_kb.rs` |
| `command-exists?` | `scheme/src/runtime/state_sync_inject_kb.rs` |
| `create-buffer` | `scheme/src/runtime/editor_ops.rs` |
| `current-buffer-file` | `scheme/src/runtime/state_sync_inject.rs` |
| `current-buffer-name` | `scheme/src/runtime/state_sync_inject.rs` |
| `current-column` | `scheme/src/runtime/state_sync_inject.rs` |
| `current-line-number` | `scheme/src/runtime/state_sync_inject.rs` |
| `current-mode` | `scheme/src/runtime/test_primitives.rs` |
...
| `define-keymap` | `scheme/src/runtime/keybindings.rs` |
| `define-option!` | `scheme/src/runtime/io_packages.rs` |
| `deprecate-function!` | `scheme/src/runtime/kb_queries.rs` |
| `display-buffer-policy` | `scheme/src/runtime/editor_ops.rs` |
| `execute-ex` | `scheme/src/runtime/editor_ops.rs` |
| `exit` | `scheme/src/runtime/test_primitives.rs` |
| `feature-available?` | `scheme/src/runtime/state_sync_inject_kb.rs` |
| `featurep` | `scheme/src/runtime/io_packages.rs` |
| `feed-keys` | `scheme/src/runtime/test_primitives.rs` |
| `file-exists?` | `scheme/src/runtime/io_packages.rs` |
| `gc-stats` | `scheme/src/runtime/keybindings.rs` |
| `get-buffer-by-name` | `scheme/src/runtime/state_sync_inject_kb.rs` |
| `get-option` | `scheme/src/runtime/state_sync_inject_kb.rs` |
| `get-selection` | `scheme/src/runtime/state_sync_inject.rs` |
| `goto-char` | `scheme/src/runtime/test_primitives.rs` |
| `kb-add-link!` | `scheme/src/runtime/kb_primitives.rs` |
| `kb-add-member` | `scheme/src/runtime/kb_primitives.rs` |
| `kb-add-meta-member!` | `scheme/src/runtime/kb_primitives.rs` |
| `kb-add-rel-type!` | `scheme/src/runtime/kb_primitives.rs` |
| `kb-agenda` | `scheme/src/runtime/io_packages.rs` |
| `kb-approve` | `scheme/src/runtime/kb_primitives.rs` |
...
| `kb-graph-view-navigate` | `scheme/src/runtime/kb_graph_view.rs` |
| `kb-graph-view-open` | `scheme/src/runtime/kb_graph_view.rs` |
| `kb-graph-view-refresh` | `scheme/src/runtime/kb_graph_view.rs` |
| `kb-graph-view-select-current` | `scheme/src/runtime/kb_graph_view.rs` |
| `kb-graph-view-set-depth` | `scheme/src/runtime/kb_graph_view.rs` |
| `kb-graph-view-set-pinned` | `scheme/src/runtime/kb_graph_view.rs` |
| `kb-graph-view-state` | `scheme/src/runtime/kb_graph_view.rs` |
| `kb-graph-view-toggle-overlay` | `scheme/src/runtime/kb_graph_view.rs` |
| `kb-graph-view-zoom-to` | `scheme/src/runtime/kb_graph_view.rs` |
| `kb-history` | `scheme/src/runtime/io_packages.rs` |
| `kb-join` | `scheme/src/runtime/kb_primitives.rs` |
| `kb-join-p2p` | `scheme/src/runtime/kb_primitives.rs` |
| `kb-join-ticket` | `scheme/src/runtime/kb_primitives.rs` |
| `kb-leave` | `scheme/src/runtime/kb_primitives.rs` |
| `kb-links-from` | `scheme/src/runtime/kb_queries.rs` |
| `kb-links-to` | `scheme/src/runtime/kb_queries.rs` |
| `kb-links-typed` | `scheme/src/runtime/kb_queries.rs` |
| `kb-list-remote` | `scheme/src/runtime/kb_primitives.rs` |
| `kb-meta-members` | `scheme/src/runtime/kb_queries.rs` |
| `kb-neighborhood` | `scheme/src/runtime/kb_queries.rs` |
| `kb-pending` | `scheme/src/runtime/kb_primitives.rs` |
| `kb-preview-dismiss` | `scheme/src/runtime/kb_preview.rs` |
| `kb-preview-show` | `scheme/src/runtime/kb_preview.rs` |
| `kb-raw-query` | `scheme/src/runtime/io_packages.rs` |
| `kb-register` | `scheme/src/runtime/kb_primitives.rs` |
| `kb-rel-types` | `scheme/src/runtime/kb_queries.rs` |
| `kb-related` | `scheme/src/runtime/kb_queries.rs` |
| `kb-remove-link!` | `scheme/src/runtime/kb_primitives.rs` |
...
| `kb-set-role` | `scheme/src/runtime/kb_primitives.rs` |
| `kb-share` | `scheme/src/runtime/kb_primitives.rs` |
| `kb-share-p2p` | `scheme/src/runtime/kb_primitives.rs` |
...
| `message` | `scheme/src/runtime/editor_ops.rs` |
| `messages-buffer-text` | `scheme/src/runtime/test_primitives.rs` |
| `module-flags` | `scheme/src/runtime/io_packages.rs` |
| `module-list` | `scheme/src/runtime/io_packages.rs` |
| `module-loaded?` | `scheme/src/runtime/io_packages.rs` |
| `module-version` | `scheme/src/runtime/io_packages.rs` |
| `open-file` | `scheme/src/runtime/editor_ops.rs` |
| `point` | `scheme/src/runtime/state_sync_inject.rs` |
| `point-max` | `scheme/src/runtime/state_sync_inject.rs` |
| `point-min` | `scheme/src/runtime/state_sync_inject.rs` |
| `provide-feature` | `scheme/src/runtime/io_packages.rs` |
| `read-file` | `scheme/src/runtime/io_packages.rs` |
| `recent-files-add!` | `scheme/src/runtime/shell_agenda.rs` |
| `recent-projects-add!` | `scheme/src/runtime/shell_agenda.rs` |
| `redo-available?` | `scheme/src/runtime/state_sync_inject_kb.rs` |
| `region-active?` | `scheme/src/runtime/state_sync_inject.rs` |
| `region-beginning` | `scheme/src/runtime/state_sync_inject.rs` |
| `region-end` | `scheme/src/runtime/state_sync_inject.rs` |
| `register-ai-tool!` | `scheme/src/runtime/kb_queries.rs` |
| `register-module!` | `scheme/src/runtime/io_packages.rs` |
| `register-splash-art!` | `scheme/src/runtime/kb_queries.rs` |
| `register-splash-art-image!` | `scheme/src/runtime/kb_queries.rs` |
| `remove-hook!` | `scheme/src/runtime/keybindings.rs` |
| `require-feature` | `scheme/src/runtime/io_packages.rs` |
| `run-command` | `scheme/src/runtime/editor_ops.rs` |
| `set-buffer-kind-replaceable!` | `scheme/src/runtime/editor_ops.rs` |
| `set-display-rule!` | `scheme/src/runtime/editor_ops.rs` |
...
| `shell-cwd` | `scheme/src/runtime/state_sync_inject.rs` |
| `shell-read-output` | `scheme/src/runtime/state_sync_inject.rs` |
| `shell-send-input` | `scheme/src/runtime/shell_agenda.rs` |
| `string-contains?` | `scheme/src/runtime/misc_primitives.rs` |
| `string-downcase` | `scheme/src/runtime/misc_primitives.rs` |
| `string-join` | `scheme/src/runtime/misc_primitives.rs` |
| `string-replace` | `scheme/src/runtime/misc_primitives.rs` |
| `string-split` | `scheme/src/runtime/misc_primitives.rs` |
| `string-trim` | `scheme/src/runtime/misc_primitives.rs` |
| `string-upcase` | `scheme/src/runtime/misc_primitives.rs` |
| `switch-to-buffer` | `scheme/src/runtime/editor_ops.rs` |
| `test-buffer-string` | `scheme/src/runtime/test_primitives.rs` |
| `test-buffer-text` | `scheme/src/runtime/test_primitives.rs` |
| `test-cursor-col` | `scheme/src/runtime/test_primitives.rs` |
| `test-cursor-row` | `scheme/src/runtime/test_primitives.rs` |
| `test-encode-state` | `scheme/src/runtime/test_primitives.rs` |
| `test-get-buffer-by-name` | `scheme/src/runtime/test_primitives.rs` |
| `test-get-option` | `scheme/src/runtime/test_primitives.rs` |
| `test-pending-updates` | `scheme/src/runtime/test_primitives.rs` |
| `test-region-active?` | `scheme/src/runtime/test_primitives.rs` |
| `test-region-end` | `scheme/src/runtime/test_primitives.rs` |
| `test-region-start` | `scheme/src/runtime/test_primitives.rs` |
| `test-search-forward` | `scheme/src/runtime/test_primitives.rs` |
| `test-status-message` | `scheme/src/runtime/test_primitives.rs` |
| `test-sync-content` | `scheme/src/runtime/test_primitives.rs` |
| `test-sync-enabled?` | `scheme/src/runtime/test_primitives.rs` |
| `undefine-command!` | `scheme/src/runtime/io_packages.rs` |
| `undefine-key!` | `scheme/src/runtime/editor_ops.rs` |
| `undefine-option!` | `scheme/src/runtime/io_packages.rs` |
| `undo-available?` | `scheme/src/runtime/state_sync_inject_kb.rs` |
| `unload-feature` | `scheme/src/runtime/io_packages.rs` |
| `visual-buffer-add-circle!` | `scheme/src/runtime/editor_ops.rs` |
| `visual-buffer-add-line!` | `scheme/src/runtime/editor_ops.rs` |
| `visual-buffer-add-rect!` | `scheme/src/runtime/editor_ops.rs` |
| `visual-buffer-add-text!` | `scheme/src/runtime/editor_ops.rs` |
| `visual-buffer-clear!` | `scheme/src/runtime/editor_ops.rs` |
| `which-key-entry-count` | `scheme/src/runtime/test_primitives.rs` |
| `which-key-open?` | `scheme/src/runtime/test_primitives.rs` |
| `write-file` | `scheme/src/runtime/test_primitives.rs` |

## Commands (565 built-in)
