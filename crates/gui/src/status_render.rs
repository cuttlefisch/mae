...
pub fn render_status_bar(
    ...
    // Mode label.
    let mode_len = mae_core::grapheme::display_width_with(mode_str.as_str(), editor.width_policy());
    ...
    let right_w =
        mae_core::grapheme::display_width_with(layout.right_text.as_str(), editor.width_policy());
    ...
    if layout.right_styled_spans.is_empty() {
        ...
        for span in &layout.right_styled_spans {
            ...
            if span.byte_offset > byte_pos {
                ...
                col += mae_core::grapheme::display_width_with(plain, editor.width_policy());
            }
            ...
            let w = mae_core::grapheme::display_width_with(styled_text, editor.width_policy());
