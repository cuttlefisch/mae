        ...
        OptionRegistry {
            options: vec![
                ...
                opt!("kb_search_sort", &["kb-search-sort"],
                    "KB search result ordering: relevance (default), activity (recent first), alphabetical",
                ...
                opt!("kb_backup_interval", &["kb-backup-interval"],
                    "Minutes between automatic KB backups (0 to disable)",
                    OptionKind::Int, "1440", Some("kb.backup_interval"), &[]),
                opt!("kb_backup_retention", &["kb-backup-retention"],
                    "Number of KB backup snapshots to retain",
