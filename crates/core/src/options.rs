    ...
    pub fn new() -> Self {
        OptionRegistry {
            options: vec![
                ...
                OptionDef {
                    name: "large_file_lines",
                    aliases: &["large-file-lines"],
                    doc: "Line count threshold for viewport-local syntax highlighting",
                    kind: OptionKind::Int,
                    default_value: "5000",
                    config_key: Some("performance.large_file_lines"),
                    valid_values: &[],
                },
                OptionDef {
                    name: "degrade_threshold_chars",
                    aliases: &["degrade-threshold-chars"],
                    doc: "Character count above which all features degrade (display regions, full markup)",
                    kind: OptionKind::Int,
                    default_value: "500000",
                    config_key: Some("performance.degrade_threshold_chars"),
                    valid_values: &[],
                },
                OptionDef {
                    name: "degrade_threshold_line_length",
                    aliases: &["degrade-threshold-line-length"],
                    doc: "Maximum line length before degradation triggers",
                    kind: OptionKind::Int,
                    default_value: "10000",
                    config_key: Some("performance.degrade_threshold_line_length"),
                    valid_values: &[],
                },
                OptionDef {
                    name: "display_region_debounce_ms",
                    aliases: &["display-region-debounce-ms"],
                    doc: "Milliseconds to debounce display region recomputation after edits",
                    kind: OptionKind::Int,
                    default_value: "150",
                    config_key: Some("performance.display_region_debounce_ms"),
                    valid_values: &[],
                },
                OptionDef {
                    name: "syntax_reparse_debounce_ms",
                    aliases: &["syntax-reparse-debounce-ms"],
                    doc: "Milliseconds to debounce syntax reparse after edits",
                    kind: OptionKind::Int,
                    default_value: "50",
