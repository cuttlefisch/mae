...
/// Resolves this call's `bilingual_kb_export::html_graph::ChordDiagramConfig`:
...
) -> bilingual_kb_export::html_graph::ChordDiagramConfig {
    let mut cfg = bilingual_kb_export::html_graph::ChordDiagramConfig {
...
/// (`bilingual_kb_export::html_graph::ChordDiagramConfig`) -- accepted keys:
...
pub fn execute_kb_export_subgraph_html(
    ...
    let html = bilingual_kb_export::html_graph::HtmlGraphExporter.export_with_config(
        &export_nodes,
        &export_edges,
        id,
        &page_title,
